...
if __name__ == "__main__":
    ...
    # Run on 0.0.0.0 to be accessible within the sandbox network
    print(f"Starting Flask server on 0.0.0.0:5001")
    # Use a production-ready server like waitress or gunicorn in a real deployment
    # For simplicity here, we stick with Flask's built-in server but disable debug mode
